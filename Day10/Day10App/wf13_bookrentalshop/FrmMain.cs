...
namespace wf13_bookrentalshop
{
    public partial class FrmMain : Form
    {
        ...
        {
            if (form == null)   // 한번도 창을 안열었으면
            {
                form = (Form)Activator.CreateInstance(type);    // 리프렉션으로 타입에 맞는 창을 새로 생성
                form.MdiParent = this;  // FrmMian이 MDI 부모
