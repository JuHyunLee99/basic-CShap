...
namespace cs21_property
{
    class Boiler
    {
        ...
        public void SetTemp(int temp)
        {
            if (temp <= 10 || temp>=70)
            {
                //Console.WriteLine("수온설정값이 너무 낮거나 높습니다. 10~70도 사이로 지정해주서에요");
                //return;
                this.temp = 10;
            }
            this.temp = temp;
    ...
    class Car
    {
        ...
        // get만 쓰면 get만 할수 있음(읽기전용) 사용자가 name을 set할 수 없게 만듬.
        // get을 안쓸수는 없음.
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //// ...
            //kitturami.temp = 300000;   // 보일러 물수온인 30만도?
